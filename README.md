...
|--------|----------|--------|------|-------|
| [`ปปส/`](ปปส/) | สำนักงาน ป.ป.ส. (ONCB) | เบาะแส/ร้องเรียนยาเสพติดรายเดือน รายจังหวัด (2560–2569) | 8,669 แถว · 194,795 เบาะแส | **SARIMA** time-series forecast |
...
> ดึงจาก ONCB API สาธารณะ · รายเดือน 114 เดือน · แยก **5 กลุ่มเป้าหมาย × 3 ผลตรวจสอบ** ต่อจังหวัดต่อเดือน
...
**MAE 610 · RMSE 691 · MAPE 18.8%** แล้วพยากรณ์ล่วงหน้า 12 เดือน พร้อมช่วงความเชื่อมั่น 95% · เห็นได้ชัดว่าเบาะแส**พุ่งสูงขึ้นมากในปี 2568–2569**
