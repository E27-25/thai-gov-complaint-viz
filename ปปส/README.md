...
- 🏙️ **กระจุกที่เมืองใหญ่ (ยอดรวม)** — กรุงเทพฯ 26,035 · ปทุมธานี 5,766 · ชลบุรี 5,654 · ขอนแก่น 5,485 · สมุทรปราการ 5,356
- 👥 **ถ่วงน้ำหนักด้วยประชากร (ต่อแสนคน)** — ภาพเปลี่ยน! พระนครศรีอยุธยา 524 · สระบุรี 480 · กรุงเทพฯ 477 สูงสุด · ส่วน 3 จังหวัดชายแดนใต้ (นราธิวาส 61 · ปัตตานี 62 · ยะลา 79) ต่ำสุด
...
| แผนที่เบาะแสรายจังหวัด (ยอดรวม) | Treemap: ภาค → จังหวัด |
|:---:|:---:|
| <img src="../assets/pps_map.png" width="100%"/> | <img src="../assets/pps_treemap.png" width="100%"/> |

**👥 ถ่วงน้ำหนักด้วยประชากร (per-capita)** — เบาะแสต่อประชากร 100,000 คน · เผยภาพต่างจากยอดรวม: ภาคกลางพุ่งสูง ส่วนชายแดนใต้ต่ำสุด

<p align="center"><img src="../assets/pps_percapita.png" width="52%" alt="เบาะแสต่อประชากรรายจังหวัด"/></p>
...
> notebook อ่านข้อมูลจาก `../data/` อัตโนมัติ (ถ้าไม่พบจะ auto-fetch จาก API · ประชากรฝังไว้ในตัว notebook ด้วย) — เปิดใน Colab ก็รันได้
> ประชากรรายจังหวัด: [Wikipedia — Provinces of Thailand](https://en.wikipedia.org/wiki/Provinces_of_Thailand)
